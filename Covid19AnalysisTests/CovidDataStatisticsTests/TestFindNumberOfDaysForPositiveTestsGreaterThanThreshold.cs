...
namespace Covid19AnalysisTests.CovidDataStatisticsTests
{
    /// <summary>
    ///     <para>
    ///         Testing The functionality of the FindNumberOfDaysForPositiveTestsGreaterThanThreshold Method in the
    ...
    ///     <para>TestCase: TestFindNoRecordsGreaterThanThreshold</para>
    ///     <para>Input: {record1.PositiveTests = 30} ExpectedOutput: 0</para>
    ///     <para>TestCase: TestFindARecordOnThreshold</para>
    ///     <para>Input: {record1.PositiveTests = 30,record2.PositiveTests = 40} ExpectedOutput: 0</para>
    ///     <para>TestCase: TestFindARecordGreaterThanThreshold</para>
    ///     <para>Input: {record1.PositiveTests = 30,record2.PositiveTests = 40, record3.PositiveTests = 50} ExpectedOutput: 1</para>
    /// </summary>
    [TestClass]
    public class TestFindNumberOfDaysForPositiveTestsGreaterThanThreshold
    {
        #region Methods
        ...
        [TestMethod]
        public void TestFindNoRecordsGreaterThanThreshold()
        {
            var covidCollection = new CovidDataCollection
                {this.record1};
            var covidStatistics = new CovidDataStatistics(covidCollection);
        ...
        [TestMethod]
        public void TestFindARecordGreaterThanThreshold()
        {
            var covidCollection = new CovidDataCollection {
                this.record1,
                this.record2,
